          ...
          <ul className={styles.menuList}>
            ...
            <li>
              <a  className={`${styles.menuItem} pl-5`}>
                ...
                <p className="text text_color_inactive text_type_main-default pl-2 pt-4 pb-4 pr-5">Лента заказов</p>
              </a>
            </li>
            </ul>
            ...
            <div className={styles.profile} >
              <a className={styles.menuItem}>
                ...
                <p className="text text_color_inactive text_type_main-default pl-2 pt-4 pb-4 pr-5">Личный кабинет</p>
              </a>
            </div>
        </nav>
      </header>
